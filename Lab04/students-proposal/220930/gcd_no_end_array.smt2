...
;  (define-fun x () (Array Int Int) (store (store (store ((as const (Array Int Int)) 0) 3 12) 2 16) 1 60))
;  (define-fun y () (Array Int Int) (store (store (store ((as const (Array Int Int)) 0) 3 4) 2 12) 1 16))
